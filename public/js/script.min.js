...
$(window).on('scroll',function(){filter();});$("#testimonials").slick({infinite:true,arrows:false,autoplay:true,autoplaySpeed:4000});var wow=new WOW({offset:100,mobile:false});var scrolled=false;$(window).on('scroll',function(){if(!scrolled){scrolled=true;wow.init();}})
